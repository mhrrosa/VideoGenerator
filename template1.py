...
def gerar():
    ...
    video = VideoFileClip("templates/template1/template_qual_das_duas_voce_investiria.mp4")
    ...
    for num_exe, tickers in dict_exe.items():
        ...
        video_editado.write_videofile(f"videos/template1/{ticker1}-{ticker2}{num_exe}.mp4", codec="libx264", fps=video.fps)
